...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if (_trafficLight.getCurrentPhase() != green)                // If there is a read light, wait for a green one by calling waitForGreen Loop
    {                                                           // this blocks this thread untill the light is green
        _trafficLight.waitForGreen();                               // does this need to be a while loop?
    }
